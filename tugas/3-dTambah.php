  ...
  <body>
    ...
    <div class="container pt-2 pb-2">
      ...
      <div class="d-flex justify-content-center pt-3 pb-3">
        <h1 class="fw-bolder">Formulir Penambahan Departemen</h1>
      </div>
    <!-- Akhir Keterangan --> 
    ...
    <!-- Formulir -->
      <form action="" method ="post" enctype="multipart/form-data" class="row g-3">
          ...
          <input class="form-control" type="text" name="departemen_name" id="departemen_name" required autocomplete ="off">  
        </div>
